...
package com.verso_eu.facebook.graph.commands.albums
{
	...
	public class CreateAlbum extends GraphCall
	{
		public function CreateAlbum(albumName:String)
		{
			super('me/albums', _data, null, URLRequestMethod.POST, false);

			_data.name = albumName;
		}
		...
		override protected function callCompleteHandler(e:Event):void
		{
			...
			var result:Object = FacebookGraph.getInstance().JSONHelper.parse(e.target.data.toString());
